...
namespace WpfApp1
{
    ...
    class Bootstrapper : BootstrapperBase
    {
        ...
        protected override void Configure()
        {
            ...
            _batch.AddExportedValue(new Lib.ConnectPlc1( ));
           // _batch.AddExportedValue(new AlmViewModel());
            //_batch.AddExportedValue(new AsixViewmodel());
            //_batch.AddExportedValue(new LiveChartViewModel());
